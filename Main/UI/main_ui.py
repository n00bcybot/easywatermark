...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.sp_images_tools.sizePolicy().hasHeightForWidth())
        self.sp_images_tools.setSizePolicy(sizePolicy1)
        self.sp_images_tools.setMinimumSize(QSize(150, 500))
        ...
        self.layout_toolbox.setMaximumSize(QSize(300, 500))
